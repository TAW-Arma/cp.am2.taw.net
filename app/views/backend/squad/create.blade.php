        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-sortable="false">
                <header>
                    ...
                    <h2>{{ Lang::get('squad.h2_create') }}</h2>
                </header>
                <div>
                    <div class="jarviswidget-editbox">
                    </div>
                    <div class="widget-body no-padding">
                        <form action="/backend/squad/create" method="post" id="squad-form" class="smart-form" novalidate="novalidate" enctype="multipart/form-data">
                            <fieldset>
                                <div class="row">
                                    <section class="col col-6">
                                        ...
                                        <label class="input">
                                            <input type="text" name="nickname" placeholder="{{ Lang::get('squad.label_nickname') }}" />
                                        </label>
                                    </section>
                                    <section class="col col-6">
                                        ...
                                        <label class="input">
                                            <input type="text" name="name" placeholder="{{ Lang::get('squad.label_name') }}" />
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    <section class="col col-6">
                                        ...
                                        <label class="input">
                                            <input type="text" name="email" placeholder="{{ Lang::get('squad.label_email') }}" />
                                        </label>
                                    </section>
                                    <section class="col col-6">
                                        ...
                                        <label class="input">
                                            <input type="text" name="web" placeholder="{{ Lang::get('squad.label_web') }}" />
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    <section class="col col-6">
                                        ...
                                        <label class="input">
                                            <input type="text" name="title" placeholder="{{ Lang::get('squad.label_title') }}" />
                                        </label>
                                    </section>
                                    <section class="col col-6">
                                        <label for="picture">
                            ...
                            <footer>
                                ...
                                <a class="btn btn-default" href="/backend#backend/squad">Cancel</a>
                            </footer>
                        </form>
                    </div>
                </div>
