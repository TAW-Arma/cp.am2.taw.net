        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-sortable="false">
                <header>
                    ...
                    <h2>{{ Lang::get('permissions.h2_update', array('description' => $permission->description)) }}</h2>
                </header>
                <div>
                    <div class="jarviswidget-editbox">
                    </div>
                    <div class="widget-body no-padding">
                        <form action="/backend/security/permission/update/{{ $permission->id; }}" method="post" id="permission-form" class="smart-form" novalidate="novalidate">
                            <fieldset>
                                <div class="row">
                                    <section class="col col-6">
                                        ...
                                        <label class="input">
                                            <input type="text" name="name" placeholder="{{ Lang::get('permissions.label_name') }}" value="{{ $permission->name; }}" />
                                        </label>
                                    </section>
                                    <section class="col col-6">
                                    </section>
                                ...
                                <div class="row">
                                    <section class="col col-6">
                                        ...
                                        <label class="textarea">
                                            <textarea name="description" placeholder="{{ Lang::get('permissions.label_description') }}">{{ $permission->description }}</textarea>
                                        </label>
                                    </section>
                                    <section class="col col-6">
                                    </section>
